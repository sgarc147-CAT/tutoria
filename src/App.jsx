...
import {
  ...
  MessageCircle, MessageSquare, ShieldAlert, CalendarClock, Cake
} from "lucide-react";
...
export default function App() {
  ...
  const [activeGroup, setActiveGroup] = useState("ADM2");
  ...
  const [moduleCourse, setModuleCourse] = useState(DEFAULT_MODULE_COURSE);
  const [classTemplate, setClassTemplate] = useState(CLASS_TEMPLATE_SEED);
  ...
  const [holidays, setHolidays] = useState([]); // dates "AAAA-MM-DD" marcades com a festiu/vacances
